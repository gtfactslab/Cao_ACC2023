function xdot = f(x, u, obs_y, obs_z)
    ...
    input_uncertainty = 0;
    uhat = u + input_uncertainty;
    u = u - input_uncertainty;
    
    % gravity
    g = 9.81;
    
    % disturbance solely based on altitude
    [wy, whaty] = disturbance_bounds_fitparam(x(3), xhat(3), obs_y);
    [wz, whatz] = disturbance_bounds_fitparam(x(3), xhat(3), obs_z);
